      ...
      <div className="container">
        ...
        {isEmpty && (
          <div className={styles.empty}>
            ...
            <h2 className={styles.emptyTitle}>{dict.projects.emptyTitle}</h2>
            <p className={styles.emptyBody}>{dict.projects.emptyBody}</p>
            <Link href={`/${typedLocale}/blog`} className={styles.emptyCta}>
